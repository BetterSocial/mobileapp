...
function EightyEight_hundred(props) {
  return (
    <Svg width="1em" height="1em" viewBox="0 0 16 16" fill="none" {...props}>
      ...
      />
      <Path d="M8 4.8a4.5 4.5 0 00-3.182 1.318L8 9.3V4.8z" fill={props.fill || COLORS.gray410} />
    </Svg>
  );
}

const MemoEightyEight_hundred = React.memo(EightyEight_hundred);
export default MemoEightyEight_hundred;

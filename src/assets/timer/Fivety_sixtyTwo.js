...
function Fivety_sixtyTwo(props) {
  return (
    <Svg width="1em" height="1em" viewBox="0 0 16 16" fill="none" {...props}>
      ...
      />
      <Path d="M8 4.8a4.5 4.5 0 100 9v-9z" fill={props.fill || COLORS.gray410} />
    </Svg>
  );
}

const MemoFivety_sixtyTwo = React.memo(Fivety_sixtyTwo);
export default MemoFivety_sixtyTwo;

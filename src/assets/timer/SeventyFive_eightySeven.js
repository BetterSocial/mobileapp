...
function SeventyFive_eightySeven(props) {
  return (
    <Svg width="1em" height="1em" viewBox="0 0 16 16" fill="none" {...props}>
      ...
      />
      <Path d="M8 4.8a4.5 4.5 0 00-4.5 4.5H8V4.8z" fill={props.fill || COLORS.gray410} />
    </Svg>
  );
}

const MemoSeventyFive_eightySeven = React.memo(SeventyFive_eightySeven);
export default MemoSeventyFive_eightySeven;

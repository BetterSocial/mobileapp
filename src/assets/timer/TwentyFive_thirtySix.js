...
function TwentyFive_thirtySix(props) {
  return (
    <Svg width="1em" height="1em" viewBox="0 0 16 16" fill="none" {...props}>
      ...
      />
      <Path d="M8 4.8a4.5 4.5 0 104.5 4.5H8V4.8z" fill={props.fill || COLORS.gray410} />
    </Svg>
  );
}

const MemoTwentyFive_thirtySix = React.memo(TwentyFive_thirtySix);
export default MemoTwentyFive_thirtySix;

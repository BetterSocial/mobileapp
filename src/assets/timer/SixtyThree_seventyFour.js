...
function SixtyThree_seventyFour(props) {
  return (
    <Svg width="1em" height="1em" viewBox="0 0 16 16" fill="none" {...props}>
      ...
      />
      <Path d="M8 4.8a4.5 4.5 0 00-3.182 7.682L8 9.3V4.8z" fill={props.fill || COLORS.gray410} />
    </Svg>
  );
}

const MemoSixtyThree_seventyFour = React.memo(SixtyThree_seventyFour);
export default MemoSixtyThree_seventyFour;

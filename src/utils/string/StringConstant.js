...
let signInScreenHumanIdDetail = "is an independent non-profit guaranteeing your privacy and anonymity. BetterSocial will receive absolutely zero personal information."

// Onboarding - Choose Username
let onboardingChooseUsernameHeadline = "Choose your username"
let onboardingChooseUsernameSubHeadline = "Ping does not require real names - just make sure your friends will find & recognize you"
let onboardingChooseUsernameBlueBoxHint = "Whatever your username, you will always be able to post anonymously."
...
let onboardingChooseUsernameLabelJustANumber = "Username cannot be just a number"
let onboardingChooseUsernameLabelUserAvailable = (username) =>  `Congrats - ${username} is still available`
let onboardingChooseUsernameLabelUserTaken = (username) =>  `Sorry, ${username} has already been taken`

// Onboarding - Local Community
let onboardingLocalCommunityHeadline = "Find your local community"
let onboardingLocalCommunitySubHeadline = "Join up to two cities you call home. Locations can only be adjusted or added infrequently."
let onboardingLocalCommunityPrimaryLocationTitle = "Add New Location"
let onboardingLocalCommunityPrimaryLocationSubTitle = "Search your favorite location"
let onboardingLocalCommunitySecondaryLocationTitle = "Add a second location"
let onboardingLocalCommunitySecondaryLocationSubTitle = "🏡 Home away from home? Add a second location"


// Onboarding - Topics
let onboardingTopicsHeadline = "Pick your topics of interest"
let onboardingTopicsSubHeadline = "Find like-minded people"
let onboardingTopicsOthersCannotSee = "Others cannot see which topics you're following"
...
// Splash Screen
let splashScreenDeeplinkGetProfileNotFound = (username) => `${username}'s profile not found`

...
const baseSize = {
  ...
  TOPIC_FEED_NAVIGATION_HEIGHT_COVER: 100,
...
const size = {
  ...
  FEED_CONTENT_HEIGHT: normalizeDimenByWidth(baseSize.BASE_FEED_CONTENT_HEIGHT),
  ...
  TOPIC_FEED_NAVIGATION_HEIGHT_COVER: normalizeDimenByWidth(
    baseSize.TOPIC_FEED_NAVIGATION_HEIGHT_COVER
  ),
  ...
  ONBOARDING_BETTER_LOGO_HEIGHT: normalizeDimenByWidth(baseSize.ONBOARDING_BETTER_LOGO_HEIGHT),

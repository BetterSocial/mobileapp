...
const StorageUtils = {
  ...
  signedUserId: storageBuilder(StorageKeysEnum.SignedUserId),
  anonymousUserId: storageBuilder(StorageKeysEnum.AnonymousUserId),
...
export interface IStorageUtils {
  ...
  signedUserId: Storage;
  anonymousUserId: Storage;
  clearAll: () => void;
}

...
import ContainerComment, {styles, ContainerReply, isEqual, ReplyComment} from '../../../src/components/Comments/ContainerComment'
...
describe('ContainerComment should run correctly', () => {
    ...
    it('Should match snapshot', () => {
        ...
        const {toJSON} = render(<ContainerComment refreshChildComment={refreshChildComment} navigateToReplyView={navigateToReplyView} findCommentAndUpdate={findCommentAndUpdate} refreshComment={refreshComment} comments={comments} indexFeed={undefined} isLoading={false}  />, {wrapper: Store})
    ...
    //     const navigateToReplyView = jest.fn()
    //     const findCommentAndUpdate = jest.fn()
    //     const {getByTestId} = render(<ContainerComment refreshChildComment={refreshChildComment} navigateToReplyView={navigateToReplyView} findCommentAndUpdate={findCommentAndUpdate} refreshComment={refreshComment} comments={comments} indexFeed={undefined} isLoading={false}  />, {wrapper: Store})
    ...
    it('ContainerReply should match snapshot', () => {
        const {toJSON, getAllByTestId} = render(<ContainerReply ><View testID='children' /> </ContainerReply>)
        expect(toJSON).toMatchSnapshot()
    ...
    //     const navigateToReplyView = jest.fn()
    //     const findCommentAndUpdate = jest.fn()
    //     const {getAllByTestId} = render(<ContainerComment refreshChildComment={refreshChildComment} navigateToReplyView={navigateToReplyView} findCommentAndUpdate={findCommentAndUpdate} refreshComment={refreshComment} comments={comments} indexFeed={undefined} isLoading={false}  />, {wrapper: Store})
    ...
    it('ReplyComment should match snapshot', () => {
        ...
        const indexFeed = 0
        const findCommentAndUpdate = jest.fn()
        const {toJSON} = render(<ReplyComment countComment={comments2[0].children_counts.comment} indexFeed={indexFeed} findCommentAndUpdate={findCommentAndUpdate} navigateToReplyView={navigateToReplyView} data={comments2[0].latest_children.comment}  />)
        expect(toJSON).toMatchSnapshot()
    })
...
//         const indexFeed = 0
//         const findCommentAndUpdate = jest.fn()
//         const {getByTestId} = render(<ReplyComment countComment={comments2[0].children_counts.comment} indexFeed={indexFeed} findCommentAndUpdate={findCommentAndUpdate} navigateToReplyView={navigateToReplyView} data={comments2[0].latest_children.comment}  />)
//         fireEvent.press(getByTestId('memoComment'))
//         expect(navigateToReplyView).toHaveBeenCalled()
//     })
})

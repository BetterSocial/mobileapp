...
describe('ContainerComment should run correctly', () => {
    ...
    it('Should match snapshot', () => {
        ...
        const {toJSON} = render(<ContainerComment refreshChildComment={refreshChildComment} navigateToReplyView={navigateToReplyView} findCommentAndUpdate={findCommentAndUpdate} refreshComment={refreshComment} comments={comments} indexFeed={undefined} isLoading={false}  />)
    ...
    it('Press comment should navigate', () => {
        ...
        const navigateToReplyView = jest.fn()
        const findCommentAndUpdate = jest.fn()
        const {getByTestId} = render(<ContainerComment refreshChildComment={refreshChildComment} navigateToReplyView={navigateToReplyView} findCommentAndUpdate={findCommentAndUpdate} refreshComment={refreshComment} comments={comments} indexFeed={undefined} isLoading={false}  />)
    ...
    it('isLast level should correct', () => {
        ...
        const navigateToReplyView = jest.fn()
        const findCommentAndUpdate = jest.fn()
        const {getAllByTestId} = render(<ContainerComment refreshChildComment={refreshChildComment} navigateToReplyView={navigateToReplyView} findCommentAndUpdate={findCommentAndUpdate} refreshComment={refreshComment} comments={comments} indexFeed={undefined} isLoading={false}  />)

...
import ContainerComment, { ContainerReply, ReplyComment, isEqual, styles } from '../../../src/components/Comments/ContainerComment'
    ...
    it('Should match snapshot', () => {
        ...
        const { toJSON } = render(
            <Context.Provider value={contextValue}>
                <ContainerComment refreshChildComment={refreshChildComment} navigateToReplyView={navigateToReplyView} findCommentAndUpdate={findCommentAndUpdate} refreshComment={refreshComment} comments={comments} indexFeed={undefined} isLoading={false} />
            </Context.Provider>

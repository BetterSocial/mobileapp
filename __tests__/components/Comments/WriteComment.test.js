...
describe('WriteComment should run correctly', () => {
    ...
    it('should match snapshot', () => {
        ...
        const {toJSON, getAllByText, getByTestId} = render(<WriteComment onPress={onPress} onChangeText={onChangeText} value='test comment' username={username} showProfileConnector={true} />, {wrapper:  Store})

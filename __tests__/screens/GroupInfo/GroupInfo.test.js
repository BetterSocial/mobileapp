...
jest.mock('react-native-reanimated', () => require('react-native-reanimated/src/reanimated2/mock'));
...
describe('GroupInfo should run correctly', () => {
  ...
  beforeEach(() => {
    jest
      .spyOn(useGroupInfo, 'default')
      .mockImplementation(() => ({setIsLoadingMembers, handleOnImageClicked: mockImageClick}));
  });

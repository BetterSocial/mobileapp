...
describe('RenderItem news should run correctly', () => {
    ...
    it('should match snapshot', () => {
        ...
        const {toJSON} = render(<RenderItem item={item} onPressBlock={onPressBlock} onPressComment={onPressComment} onPressDownVote={onPressDownVote} onPressShare={onPressShare} onPressUpvote={onUpvote} />, {wrapper: Store})
